...
/* harmony import */ var _model_point_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model-point.js */ "./src/model-point.js");
...
class Card extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    ...
    <div class="event">
      ...
      <h3 class="event__title">${Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["transformFirstLetter"])(this._type)}
        ${_utils_js__WEBPACK_IMPORTED_MODULE_2__["TRANSPORT_TYPES"].includes(this._type) ? `to` : `in`}
      ${this._city}</h3>

      <div class="event__schedule">
        <p class="event__time">
          <time class="event__start-time" datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateStart)
            .format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].YEAR_MONTH_DAY)}T${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateStart).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].HOURS_MINUTES)}">
          ${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateStart).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].HOURS_MINUTES)}</time>
          &mdash;
          <time class="event__end-time" datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateFinish)
            .format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].YEAR_MONTH_DAY)}T${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateFinish).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].YEAR_MONTH_DAY)}">
          ${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateFinish).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].HOURS_MINUTES)}</time>
        </p>
        <p class="event__duration">${Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["getTimeDifference"])(this._dateStart, this._dateFinish)}</p>
      </div>
...
class CardsContainer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/day-information.js":
/*!*******************************************!*\
  !*** ./src/components/day-information.js ***!
  \*******************************************/
/*! exports provided: default */
...
class DayInformation extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    return `<div class="day__info">
      ...
      <time class="day__date" datetime="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date)
        .format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].YEAR_MONTH_DAY)}">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._date).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].MONTH_DAY)}</time>
    </div>`;
  }
}

/* harmony default export */ __webpack_exports__["default"] = (DayInformation);
...
class EditCard extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
      ...
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--destination">
          <label class="event__label  event__type-output" for="event-destination-1">
            ${Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["transformFirstLetter"])(this._type)} ${_utils_js__WEBPACK_IMPORTED_MODULE_2__["TRANSPORT_TYPES"].includes(this._type) ? `to` : `in`}
          </label>
        ...
        <div class="event__field-group  event__field-group--time">
          ...
          value="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateStart).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].DATE_TIME)}">
          &mdash;
          ...
          value="${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateFinish).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].DATE_TIME)}">
        </div>
    ...
    this.getElement()
      ...
      .forEach((typeItem) => {
        typeItem.addEventListener(`click`, (evt) => {
          ...
          this.getElement().querySelector(`.event__type-output`).textContent = `${Object(_utils_js__WEBPACK_IMPORTED_MODULE_2__["transformFirstLetter"])(typeData.type)} ${_utils_js__WEBPACK_IMPORTED_MODULE_2__["TRANSPORT_TYPES"].includes(typeData.type) ? `to` : `in`}`;
  ...
  resetForm() {
    ...
    this.getElement().querySelector(`.event__photos-tape`).insertAdjacentHTML(_utils_js__WEBPACK_IMPORTED_MODULE_2__["Position"].BEFOREEND, this._pictures.map(({src, description}) =>
      `<img class="event__photo" src="${src}" alt="${description}">`).join(``));

    if (this._additionalOptions.length > 0) {
      this.getElement().querySelector(`.event__section--offers`).classList.remove(`visually-hidden`);
      this.getElement().querySelector(`.event__available-offers`).innerHTML = ``;
      this.getElement().querySelector(`.event__available-offers`).insertAdjacentHTML(_utils_js__WEBPACK_IMPORTED_MODULE_2__["Position"].BEFOREEND, `   ${this._additionalOptions.map(({title, price, accepted}) =>
        (`<div class="event__offer-selector">
        <input class="event__offer-checkbox  visually-hidden"
        id="${title}-1" type="checkbox"
        name="${title}" ${accepted ? `checked` : ``}>
...
/* harmony default export */ __webpack_exports__["default"] = (EditCard);


/***/ }),

/***/ "./src/components/empty-result.js":
/*!****************************************!*\
  !*** ./src/components/empty-result.js ***!
  \****************************************/
/*! exports provided: default */
...
class EmptyResult extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return `<p class="trip-events__msg">Click New Event to create your first point</p>`;
  }
}

/* harmony default export */ __webpack_exports__["default"] = (EmptyResult);
...
class Information extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    ...
    <h1 class="trip-info__title">${this._cities.length > _utils_js__WEBPACK_IMPORTED_MODULE_2__["MAX_CITIES_LENGTH"]
    ? `${this._cities[0]}&mdash; ... &mdash;${this._cities[this._cities.length - 1]}`
    : `${this._cities.join(` &mdash; `)}`}</h1>
    <p class="trip-info__dates">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateStart).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].DAY_MONTH)}
      &nbsp;&mdash;&nbsp;${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._dateFinish).format(_utils_js__WEBPACK_IMPORTED_MODULE_2__["DateFormat"].DAY_MONTH)}</p>
    </div>`;
  }
}
  ...
  getTemplate() {
    return `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
      ...
      <div class="trip-sort__item  trip-sort__item--event">
        <input id="sort-event" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-event" data-sort-type="event" checked>
...
class Statistics extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _renderStat(name, container, labels, data) {
    return new chart_js__WEBPACK_IMPORTED_MODULE_1___default.a(container, {
  ...
  _renderTransportStat() {
    const transportLabels = [...new Set(this._points.map(({type}) => type)
        .filter((type) => _utils_js__WEBPACK_IMPORTED_MODULE_4__["TRANSPORT_TYPES"].includes(type)))];
  ...
  _renderTimeSpendStat() {
    ...
    const timeSpendData = timeSpendLabels.reduce((acc, label) => {
      ...
      const hoursCount = Math.floor(moment__WEBPACK_IMPORTED_MODULE_2___default.a.duration(labelTime).asHours());
      acc.push(hoursCount);
      return acc;
    }, []);
...
/***/ "./src/components/trip-container.js":
/*!******************************************!*\
  !*** ./src/components/trip-container.js ***!
  \******************************************/
/*! exports provided: default */
...
class TripContainer extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/* harmony import */ var _components_edit_card_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/edit-card.js */ "./src/components/edit-card.js");
...
class PointController {
  constructor(container, data, mode, onDataChange, onChangeView, destinations, additionalOptions) {
    ...
    this._pointView = new _components_card_js__WEBPACK_IMPORTED_MODULE_1__["default"](data);
    this._pointEdit = new _components_edit_card_js__WEBPACK_IMPORTED_MODULE_2__["default"](data, destinations, _utils_js__WEBPACK_IMPORTED_MODULE_0__["TRANSPORT_TYPES"], _utils_js__WEBPACK_IMPORTED_MODULE_0__["PLACE_TYPES"], additionalOptions);
    this.init(mode);
  }

  init(mode) {
    let renderPosition = _utils_js__WEBPACK_IMPORTED_MODULE_0__["Position"].BEFOREEND;
    let currentView = this._pointView;

    if (mode === _utils_js__WEBPACK_IMPORTED_MODULE_0__["Mode"].ADDING) {
      renderPosition = _utils_js__WEBPACK_IMPORTED_MODULE_0__["Position"].AFTERBEGIN;
    ...
    const onEscKeyDown = (evt) => {
      if (evt.key === _utils_js__WEBPACK_IMPORTED_MODULE_0__["Key"].ESCAPE_IE || evt.key === _utils_js__WEBPACK_IMPORTED_MODULE_0__["Key"].ESCAPE) {
    ...
    flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(this._pointEdit.getElement().querySelector(`#event-start-time-1`), {
      allowInput: false,
      defaultDate: moment__WEBPACK_IMPORTED_MODULE_3___default()(this._data.dateStart).format(_utils_js__WEBPACK_IMPORTED_MODULE_0__["DateFormat"].DATE_TIME),
      dateFormat: _utils_js__WEBPACK_IMPORTED_MODULE_0__["DateFormat"].DATE_TIME_FLATPICKR,
      enableTime: true,
      [`time_24hr`]: true
    });

    flatpickr__WEBPACK_IMPORTED_MODULE_4___default()(this._pointEdit.getElement().querySelector(`#event-end-time-1`), {
      allowInput: false,
      defaultDate: moment__WEBPACK_IMPORTED_MODULE_3___default()(this._data.dateFinish).format(_utils_js__WEBPACK_IMPORTED_MODULE_0__["DateFormat"].DATE_TIME),
      dateFormat: _utils_js__WEBPACK_IMPORTED_MODULE_0__["DateFormat"].DATE_TIME_FLATPICKR,
      enableTime: true,
      [`time_24hr`]: true
    });
    ...
    this._pointEdit.getElement()
      ...
      .addEventListener(`click`, () => {
        ...
        if (mode === _utils_js__WEBPACK_IMPORTED_MODULE_0__["Mode"].ADDING) {
          Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["unrender"])(this._pointEdit.getElement());
          this._pointEdit.removeElement();
          this._onDataChange(null, null);
        } else if (mode === _utils_js__WEBPACK_IMPORTED_MODULE_0__["Mode"].DEFAULT) {
          this._pointEdit.resetForm();
          this._container.getElement().replaceChild(this._pointView.getElement(), this._pointEdit.getElement());
          document.removeEventListener(`keydown`, onEscKeyDown);
        }
    ...
    this._pointEdit.getElement()
      ...
      .addEventListener(`click`, (evt) => {
        ...
        setTimeout(this._onDataChange.bind(this,
            mode === _utils_js__WEBPACK_IMPORTED_MODULE_0__["Mode"].DEFAULT ? `update` : `create`,
            entry,
            () => {
    ...
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container.getElement(), currentView.getElement(), renderPosition);
  }
  ...
  _getNewData() {
    ...
    const entry = {
      ...
      dateStart: moment__WEBPACK_IMPORTED_MODULE_3___default()(formData.get(`event-start-time`), _utils_js__WEBPACK_IMPORTED_MODULE_0__["DateFormat"].DATE_TIME).valueOf(),
      dateFinish: moment__WEBPACK_IMPORTED_MODULE_3___default()(formData.get(`event-end-time`), _utils_js__WEBPACK_IMPORTED_MODULE_0__["DateFormat"].DATE_TIME).valueOf(),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_trip_container_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/trip-container.js */ "./src/components/trip-container.js");
/* harmony import */ var _components_cards_container_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/cards-container.js */ "./src/components/cards-container.js");
/* harmony import */ var _components_day_information_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/day-information.js */ "./src/components/day-information.js");
/* harmony import */ var _components_empty_result_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/empty-result.js */ "./src/components/empty-result.js");
/* harmony import */ var _components_information_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/information.js */ "./src/components/information.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils.js */ "./src/utils.js");
/* harmony import */ var _components_day_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/day.js */ "./src/components/day.js");
/* harmony import */ var _components_sort_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/sort.js */ "./src/components/sort.js");
/* harmony import */ var _point_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./point.js */ "./src/controllers/point.js");
...
class TripController {
  constructor(container, points, destinations, additionalOptions, onDataChange) {
    this._container = container;
    this._points = points;
    this._tripContainer = new _components_trip_container_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._emptyResult = new _components_empty_result_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._sort = new _components_sort_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
  ...
  init() {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._sort.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_5__["Position"].BEFOREEND);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container, this._tripContainer.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_5__["Position"].BEFOREEND);

    if (this._points.length === 0) {
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._tripContainer.getElement(), this._emptyResult.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_5__["Position"].BEFOREEND);
    }
  ...
  createPoint() {
    ...
    this._creatingPoint = new _point_js__WEBPACK_IMPORTED_MODULE_8__["default"](this._tripContainer,
        defaultPoint, _utils_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING, this._onDataChange, this._onChangeView, this._destinations, this._additionalOptions);
  }

  _renderBoard() {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["unrender"])(this._tripContainer.getElement());
  ...
  _renderPoints(container, point) {
    const pointController = new _point_js__WEBPACK_IMPORTED_MODULE_8__["default"](container,
        point, _utils_js__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT, this._onDataChange, this._onChangeView, this._destinations, this._additionalOptions);
  ...
  _renderDays(points) {
    ...
    const formattedDates = sortedDates.map((date) => moment__WEBPACK_IMPORTED_MODULE_9___default()(date).format(`MMM DD`));
    const uniqueDates = [...new Set(formattedDates)];

    uniqueDates.forEach((pointDate, i) => {
      i++;
      const day = new _components_day_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
      const dayInformation = new _components_day_information_js__WEBPACK_IMPORTED_MODULE_2__["default"](new Date(pointDate), i);
      const cardsContainer = new _components_cards_container_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
      const pointsForOneDay = points.filter(({dateStart}) => moment__WEBPACK_IMPORTED_MODULE_9___default()(dateStart).format(`MMM DD`) === pointDate);

      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._tripContainer.getElement(), day.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_5__["Position"].BEFOREEND);
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["render"])(day.getElement(), dayInformation.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_5__["Position"].BEFOREEND);
      Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["render"])(day.getElement(), cardsContainer.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_5__["Position"].BEFOREEND);
  ...
  _renderBySort(sortedPoints) {
    const day = new _components_day_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
    const dayInformation = new _components_day_information_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    const cardsContainer = new _components_cards_container_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  ...
  _onSortLinkClick(evt) {
    ...
    switch (evt.target.dataset.sortType) {
      case _utils_js__WEBPACK_IMPORTED_MODULE_5__["SortType"].EVENT:
        this._renderDays(this._points);
        break;
      case _utils_js__WEBPACK_IMPORTED_MODULE_5__["SortType"].TIME:
        ...
        break;
      case _utils_js__WEBPACK_IMPORTED_MODULE_5__["SortType"].PRICE:
  ...
  _onFilterClick(evt) {
    ...
    switch (evt.target.id) {
      case _utils_js__WEBPACK_IMPORTED_MODULE_5__["FilterType"].EVERYTHING:
        this._renderDays(this._points);
        break;
      case _utils_js__WEBPACK_IMPORTED_MODULE_5__["FilterType"].FUTURE:
        const filterFuturePoints = this._points.filter((point) => moment__WEBPACK_IMPORTED_MODULE_9___default()(point.dateStart).isAfter(new Date(Date.now())));
        this._renderDays(filterFuturePoints);
        break;
      case _utils_js__WEBPACK_IMPORTED_MODULE_5__["FilterType"].PAST:
        const filterPastPoints = this._points.filter((point) => moment__WEBPACK_IMPORTED_MODULE_9___default()(point.dateFinish).isBefore(new Date(Date.now())));
  ...
  updateData(points) {
    ...
    const sortedPoints = Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["getInformation"])(points.slice().sort((a, b) => a.dateStart - b.dateFinish));
    const information = new _components_information_js__WEBPACK_IMPORTED_MODULE_4__["default"](sortedPoints);

    informationParent.removeChild(informationContainer);
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["render"])(informationParent, information.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_5__["Position"].AFTERBEGIN);
    tripCost.textContent = Object(_utils_js__WEBPACK_IMPORTED_MODULE_5__["getTripCost"])(points);
  }
}
...
/* harmony import */ var _components_information_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/information.js */ "./src/components/information.js");
...
/* harmony import */ var _controllers_trip_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./controllers/trip.js */ "./src/controllers/trip.js");
...
const filtersElement = new _components_filters_js__WEBPACK_IMPORTED_MODULE_2__["default"](FILTER_TABS);
const menuElement = new _components_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
const statistics = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const api = new _api_js__WEBPACK_IMPORTED_MODULE_6__["default"]({endPoint: END_POINT, authorization: AUTHORIZATION});
const loading = new _components_loading_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
statistics.getElement().classList.add(`visually-hidden`);

Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["render"])(tripControlsHeaderElements[0], menuElement.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_3__["Position"].AFTEREND);
Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["render"])(tripControlsHeaderElements[1], filtersElement.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_3__["Position"].AFTEREND);
Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["render"])(pageBodyContainer, statistics.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_3__["Position"].BEFOREEND);
Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["render"])(tripEventsElement, loading.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_3__["Position"].BEFOREEND);

const onDataChange = (actionType, update, onError) => {
  switch (actionType) {
    case _utils_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].DELETE:
      api.deletePoint({
        id: update.id
      })
        .then(() => api.getPoints())
      ...
      break;
    case _utils_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].UPDATE:
      api.updatePoint({
        id: update.id,
        data: update.toRAW()
      })
      ...
      break;
    case _utils_js__WEBPACK_IMPORTED_MODULE_3__["ActionType"].CREATE:
      api.createPoint({
        data: update.toRAW()
      })
      .then(() => api.getPoints())
...
api.getData({url: `destinations`})
  ...
  .then((points) => {
    pointsData = points;
    pointsInformation = Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["getInformation"])(points.slice().sort((a, b) => a - b));
  })
  .then(() => {
    tripController = new _controllers_trip_js__WEBPACK_IMPORTED_MODULE_4__["default"](tripEventsElement, pointsData, tripDestinations, tripAdditionalOptions, onDataChange);
    information = new _components_information_js__WEBPACK_IMPORTED_MODULE_1__["default"](pointsInformation);
  })
  .then(() => {
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["unrender"])(loading.getElement());
    loading.removeElement();
    tripController.init();
    Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["render"])(tripInformationElement, information.getElement(), _utils_js__WEBPACK_IMPORTED_MODULE_3__["Position"].AFTERBEGIN);
    tripCostValue.textContent = Object(_utils_js__WEBPACK_IMPORTED_MODULE_3__["getTripCost"])(pointsData);
  });
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: Position, Mode, DateFormat, Key, SortType, FilterType, ActionType, MAX_CITIES_LENGTH, TRANSPORT_TYPES, PLACE_TYPES, createElement, render, unrender, getTripCost, getInformation, transformFirstLetter, getTimeDifference */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MAX_CITIES_LENGTH", function() { return MAX_CITIES_LENGTH; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRANSPORT_TYPES", function() { return TRANSPORT_TYPES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PLACE_TYPES", function() { return PLACE_TYPES; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripCost", function() { return getTripCost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getInformation", function() { return getInformation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "transformFirstLetter", function() { return transformFirstLetter; });
...
const PLACE_TYPES = [`check-in`, `sightseeing`, `restaurant`];
...
const transformFirstLetter = (string) => `${string[0].toUpperCase()}${string.substring(1)}`;

const getTimeDifference = (dateStart, dateFinish) => {
